import { Flex, Heading, Icon, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverFooter, PopoverHeader, PopoverTrigger, Portal, Spacer, Text } from "@chakra-ui/react"
                          ...
                          <Popover>
                                ...
                                <Portal>
                                  <PopoverContent>
                                    ...
                                    <PopoverCloseButton />
                                    <PopoverBody>
                                    <Box style={{ width:"20%",height:"100%", fontSize:"24px",fontWeight:"bold", alignItems:"center",margin:"auto", color:"Black" }}>
                                        {
                                          Admin ? <><Flex><Text>{Admin.email.split("@")[0] }</Text></Flex></>:null
                                        }
                                        </Box> 
                                    </PopoverBody>
                                    <PopoverFooter>
                                        ...
                                        <Modal isOpen={isOpen} onClose={onClose} style={{width:"1200px"}}>
                                          <ModalOverlay />
                                          <ModalContent>
                                            ...
                                            <ModalFooter>
                                              <Button colorScheme='blue' style={{ width: "50%", height: "50px", fontSize: "24px", color: "white", borderRadius: "15px" }} mr={3} onClick={onClose}>
                                                Close
                                              </Button>
                                              {/* <Button variant='ghost'>Secondary Action</Button> */}
                                                ...
                                                type="submit" 
                                                variant="ghost"
                                                style={{ width: "50%", height: "50px", fontSize: "24px", color: "white", borderRadius: "15px" }}
                                              >AddLandLord</Button>
