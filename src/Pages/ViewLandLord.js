          ...
          <TabPanel>
            <SimpleGrid columns={[2, null, 3]} spacing="40px">
              <Box
                ...
                alignItems="center"
                height="80px"
                key={currentLandLord._id}
              >
                Id:{currentLandLord._id}{" "}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                FirstName:{currentLandLord.firstName}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                lastName:{currentLandLord.LastName}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                Email:{currentLandLord.email}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                PhoneNumber:{currentLandLord.phone}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                country:{currentLandLord.country}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                state:{currentLandLord.state}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                city:{currentLandLord.city}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                postalCode:{currentLandLord.postalCode}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                Address:{currentLandLord.address}
              </Box>
              <Box border="1px solid black" alignItems="center" height="80px">
                AdharCard:{currentLandLord.adharCard}
              </Box>
            </SimpleGrid>
          </TabPanel>
          <TabPanel>
              ...
              <Table variant="striped" colorScheme="teal">
                ...
                <Tbody>
                  <Tr>
                    ...
                    <Td>
                      {" "}
                      <Button onClick={handleShowPdf}>View pdf</Button>
                      {flag && (
                        <iframe
                          src={`${base}${currentLandLord.document}`}
                          width={"100%"}
                          height={"500px"}
