...
import {
  Box, Button, FormControl, Input, Stack, Step, StepDescription, StepIcon, StepIndicator, StepNumber, StepSeparator, StepStatus, StepTitle, Stepper, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Select, Tab, TabList, TabPanel, TabPanels, Tabs, Text, useDisclosure, Checkbox,
} from '@chakra-ui/react';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate, useParams } from 'react-router-dom';
import { editLease, getLease } from '../Redux/Lease/action';
const steps = [
...
const EditLease = () => {
  ...
  const handleEditLease = async () => {
    ...
    try {
      await dispatch(editLease(id,payload));
    ...
    <Stack style={{ width: "100%", height: "100vh", marginTop: "15px" }}>
      <Stepper size="lg" index={active} orientation='vertical' height='400px' gap='0' marginTop={"15px"} padding={"10px"}>
        ...
        {active === steps.length - 1 && (
          ...
          }} onClick={handleEditLease}>Submit</Button>
        )}
      </Stepper>
