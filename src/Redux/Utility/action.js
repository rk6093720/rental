...
const getUtility = () => async (dispatch) => {
    ...
    return await axios.get("https://repulsive-ruby-snail.cyclic.app/utility/read")
        .then((r) => {
            console.log(r, "get")
...
const postUtility = (payload) => async (dispatch) => {
    ...
    console.log(payload)
    return await axios.post(`https://repulsive-ruby-snail.cyclic.app/utility/create`, payload)
        .then((r) => {
            console.log(r)
...
const editUtility = (id, payload) => async (dispatch) => {
    ...
    return await axios.put(`https://repulsive-ruby-snail.cyclic.app/utility/update/${id}`, payload)
        .then((r) => {
            console.log(r);
...
const deleteUtility = (id) => async (dispatch) => {
    ...
    return await axios.delete(`https://repulsive-ruby-snail.cyclic.app/utility/remove/${id}`)
        .then((r) => {
            console.log(r);
